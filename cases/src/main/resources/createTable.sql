...
create table CASES (case_id int not null, status_id int not null, customer_id int not null, created_time DATE, updated_time DATE, priority varchar(10), created_by varchar(10), updated_by varchar(10), comment varchar(50));
